...
class eposController extends epos
{
	...
	function processResult($strRsXML)
	{
		...
		$strInput = 'james.cympus.com' . $module_info->cubkey;
		$strMD5Hash = md5($strInput);	
		$strXML = sprintf("<?xml version='1.0' encoding='UTF-8'?><MERCHANTXML><CAVALUE>%s</CAVALUE><RETURL>http://james.cympus.com/modules/epos/orderinfo.php</RETURL></MERCHANTXML>", $strMD5Hash);
		echo $strXML;
		exit();
	}
